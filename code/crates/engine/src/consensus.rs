    ...
    Ctx: Context,
{
    ...
    pub fn height(&self) -> Ctx::Height {
        match &self.phase {
            ...
            ConsensusPhase::Recovering { consensus, .. }
            | ConsensusPhase::Running { consensus } => consensus.height(),
        }
    }
    ...
    pub fn round(&self) -> Round {
        match &self.phase {
            ...
            ConsensusPhase::Recovering { consensus, .. }
            | ConsensusPhase::Running { consensus } => consensus.round(),
        }
    }
    ...
    fn consensus_mut(&mut self) -> Option<&mut ConsensusState<Ctx>> {
        match &mut self.phase {
            ...
            ConsensusPhase::Recovering { consensus, .. }
            | ConsensusPhase::Running { consensus } => Some(consensus),
        }
    }
    ...
    Ctx: Context,
{
    ...
    async fn process_input(
        ...
        let consensus = match consensus_phase {
            ...
            ConsensusPhase::Recovering { consensus, .. }
            | ConsensusPhase::Running { consensus } => consensus,
        };
